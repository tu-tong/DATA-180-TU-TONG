...
Caravan and Aerostar have the shortest distance between them (3.44)
Lumina_APV and Eurovan have the largest distance between them (61.80)
...
a) Nearest-neighbor
min{d(1,2), d(1,3), d(1,5), d(4,2), d(4,3), d(4,5)} = min{1, 9, 1.6, 6, 5, 2} = 1

b) Farthest-neighbor
max{d(1,2), d(1,3), d(1,5), d(4,2), d(4,3), d(4,5)} = max{1, 9, 1.6, 6, 5, 2} = 9
...
I prefer Manhattan over Euclidean because Manhattan produces rounded results which are very clear to make comparison. For the graphs, Manhattan is easier to decide the number of clusters.
