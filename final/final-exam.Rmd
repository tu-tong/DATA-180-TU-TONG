...
e) We should deal with missing values by removing the rows or columns that contain the missing values or substituting missing values with other values (such as sample mean). However, there is no best way to approach.
